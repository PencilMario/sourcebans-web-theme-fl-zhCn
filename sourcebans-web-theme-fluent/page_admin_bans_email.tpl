<div class="admin_tab_content_title">
    <h2><i class="fas fa-envelope"></i>发送邮件<i>({$email_addr})</i></h2>
</div>
    ...
    <div class="margin-bottom">
        <table width="90%" style="border-collapse:collapse;" id="group.details" cellpadding="3">
            <tr>
                ...
                <div class="rowdesc">{help_icon title="Subject" message="Type the subject of the email."}主题</div>
                </td>
            ...
            <tr>
            <td valign="top"><div class="rowdesc">{help_icon title="Message" message="Type your message here."}留言</div></td>
            <td><div align="left">
