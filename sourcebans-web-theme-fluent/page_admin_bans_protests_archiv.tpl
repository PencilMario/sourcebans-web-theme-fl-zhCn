                                ...
                                <div class="collapse_content">
                                    <div class="cMessage cMessage_warning margin" style="font-weight: bold">
                                        <p style="text-align:center">
                                            <i class="fas fa-info-circle"></i>这{$protest.archive}由
                                    ...
                                    <div class="padding flex flex-jc:start">
                                        ...
                                        <ul class="ban_list_detal">
                                            ...
                                            <li>
                                                <span><i class="fa-solid fa-network-wired"></i>抗议者知识产权</span>
                                                <a href="https://geoiplookup.net/geo/{$protest.pip}" target="_blank" rel="noopener">{$protest.pip}</a>
                                            </li>

                                            <li>
                                                <span><i class="fa-solid fa-calendar-days"></i>抗议</span>
                                    ...
                                    <div class="ban_list_comments margin-bottom">
                                        <div class="layout_box_title">
                                            <h2><i class="fa-solid fa-pen-to-square"></i>抗议信息</h2>
                                        </div>
