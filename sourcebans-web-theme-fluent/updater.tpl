...
<html>
    ...
    <body>
        ...
        <div id="mainwrapper">
            <div id="content_title" style="padding: 1rem 0rem"><b>更新器</b></div>
            <div id="content">
                <h3>更新...</h3>
        ...
        <div id="footer">
            <div id="mainwrapper" style="text-align: center;">
    		    ...
    		    <span style="line-height: 20px;">技术支持<a href="http://www.sourcemod.net" target="_blank" style="color: #C1C1C1">SourceMod</a></span>
    		</div>
    	</div>
    </body>
</html>
